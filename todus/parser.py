...
def parse_todus_message(stanza: str) -> dict:
    ...
    # y evitar que sub-tags (file, video, etc.) contaminen los valores raíz
    ...
    result = {
        ...
        "id": _attr(m_tag, "i"),
        "type": _attr(m_tag, "t"),
        "original_id": _attr(m_tag, "mi"),  # solo del <m> raíz (edición)
        "body": "",
        "url": "",
        "file_name": "",
        "file_size": 0,
    ...
    if image_match:
        ...
        # Nota: si una stanza tuviera <file> e <image>, el último sobreescribe file_id.
        # En la práctica ToDus no envía ambos en la misma stanza.
    ...
    def feed(self, chunk: str) -> list[dict]:
        ...
        if len(self._buffer) > 20000:
            if "<" not in self._buffer:
                ...
                # Truncar conservando posible fragmento inicial válido
